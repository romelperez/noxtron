import type { RouterURLOptionControl, RouterURLOptionBoolean, RouterURLOption } from './types';

export const ROUTER_URL_OPTIONS_CONTROLS: RouterURLOptionControl[] = ['type', 'sandbox', 'code'];
